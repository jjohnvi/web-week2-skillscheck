...
// Code Here
let doubled = myNumbers.map(function(val, i) {
  return val * 2;
});
...
// Code Here
let forTheLoveOfGeorge = notGeorge.map(function(val, i) {
...
// Code Here
let enemies = people.filter(function(val, i) {
...
// Code Here
let totallyAwesome = people.reduce(function(total, val, i) {
